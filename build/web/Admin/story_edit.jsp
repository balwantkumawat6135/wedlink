<%-- 
    Document   : story_edit
    Created on : 29-Jun-2025, 10:09:42 AM
    Author     : balwant
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <%          
                                ...
                                if(r.next()){
                            %>
                            <form method="post" action="story_update.jsp">
                                <div class="form-group">
                                    <label for="title">Stroy Title</label>
                                    <input type="text" name="title" class="form-control" value="<%=r.getString(3)%>" placeholder="Story Title">
                                </div>
                                <div class="form-group">
                                    <label for="des">Stroy</label>
                                    <textarea type="text" rows="10" name="des" class="form-control" placeholder="Story"><%=r.getString(4)%></textarea>
                                </div>
