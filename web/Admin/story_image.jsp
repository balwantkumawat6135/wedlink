<%-- 
    Document   : stroy_image
    Created on : 27-Jun-2025, 10:43:47 PM
    Author     : balwant
--%>
            ...
            document.getElementById('cropButton').addEventListener('click', () => {
                if (cropper) {
                    ...
                    canvas.toBlob((blob) => {
                        ...
                        fetch('image_upload.jsp', {
                            method: 'POST',
                            body: formData
                        }).then(response => {
                            if (response.ok) {
                                alert('Upload successful');
                                window.open("http://localhost:8080/Admin/add_story.jsp?success=1", "_self");
                            } else {
